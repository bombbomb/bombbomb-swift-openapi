...
public class WebhooksAPI: APIBase {
  ...
  "url" : "aeiou"
    ...
    public class func addWebHookWithRequestBuilder(hookUrl hookUrl: String) -> RequestBuilder<BBWebHook> {
        ...
        let requestBuilder: RequestBuilder<BBWebHook>.Type = bombbomb-nodejs-openapiAPI.requestBuilderFactory.getBuilder()
    ...
    public class func deleteWebHookWithRequestBuilder(hookId hookId: String) -> RequestBuilder<String> {
        ...
        let requestBuilder: RequestBuilder<String>.Type = bombbomb-nodejs-openapiAPI.requestBuilderFactory.getBuilder()
